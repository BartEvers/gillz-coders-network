...
module.exports = async function() {
  ...
  const [kelley, rein, matias] = await Promise.all(
    [
      {
        name: "Bob",
        email: "b.vanleeuwen@gillz.nl",
        password: bcrypt.hashSync("abcd", 10),
        intro: `Hi there! I'm Bob, teacher of JavaScript, student of life`,
      ...
      },
      {
        ...
        email: "bart@gillz.nl",
        password: bcrypt.hashSync("abcd", 10),
        github_username: "BartEvers"
      },
      {
        name: "Lars",
        email: "l.noorlander@gillz.nl",
        password: bcrypt.hashSync("abcd", 10),
        intro: `Hi! I'm Lars, teacher of Gillz, from Gouda!`,
        github_username: "GillzNL"
      }
